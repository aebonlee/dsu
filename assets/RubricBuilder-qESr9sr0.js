import{C as A,I as S,r as g,l as e}from"./index-BeDtYqHd.js";import{u as C,A as I,K as T,S as w,T as E}from"./SubscribePrompt-BJlZqUYZ.js";import{u as K,A as P}from"./useApiKeys-mUZq-kbH.js";import{S as R}from"./SEOHead-RZjzWv9G.js";import"./useUsageLog-pDkXyElt.js";import"./index-eee--dwg.js";function $({taskName:a,subject:r,level:n,criteria:t,rubricType:c,language:u}){return[{role:"system",content:`You are an assessment and evaluation expert in higher education. You create detailed, fair, and measurable rubrics aligned with learning outcomes. Always respond in ${u==="ko"?"한국어":"English"}.`},{role:"user",content:`다음 정보를 바탕으로 4단계 평가 루브릭을 작성해주세요.
