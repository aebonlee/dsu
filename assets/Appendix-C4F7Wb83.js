import{C as i,l as o}from"./index-BXTeeQ2_.js";import{G as s}from"./GuidePage-ClR4r8LV.js";/* empty css                 */import"./SEOHead-6AzHUe89.js";import"./CodeBlock-Chlf0IlD.js";import"./index-Dorura7Q.js";const l={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
| **생성형 AI** | 텍스트·이미지 등 새로운 콘텐츠를 만들어내는 AI. 본 연수는 **Claude**(claude.ai)를 중심으로 실습합니다. |
...
> Stuck on a term? Ask multi-LLM to "explain this so a new staff member understands."`}]},m={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
...
- Whatever AI you use, minimize sensitive data — never input exam items or student info.`}]},c={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]},d={id:"ai-practice",icon:"fa-comment-dots",title:"AI 실전 사용법",titleEn:"AI Tools in Practice",sections:[{title:"실전 핵심 요약",titleEn:"Practical Essentials",content:`### 1. 기본 원리 — 구체적으로 물을수록 실전 답이 나옵니다
...
Documents/emails/minutes, summarizing rules & materials, tables & checklists, understanding difficult material.`},{title:"자주 쓰는 핵심 키워드",titleEn:"Essential Keywords",content:`> **형광펜 표시 = 실제로 잘 통하는 키워드**입니다. 이것만 익혀도 충분해요. 키워드는 AI의 공식 명령이 아니라 '이렇게 요청하는 습관'이라, 안 통하면 예시처럼 **뜻을 풀어서** 쓰면 됩니다. (Claude·ChatGPT 등 모두 동일)
...
> **One-line request**: "Format this to paste straight into Word — **no markdown symbols or checkboxes**, headings as '1. / 1.1' outline numbers only."`}]};function u(t,a){return a?{...t,sections:t.sections.map(e=>e.contentEn?{...e,content:`${e.content}
...
`}:e)}:t}function w(){const{language:t,bilingual:a}=i(),e=t==="ko",n=[l,m,d,c].map(r=>u(r,a));return o.jsx(s,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:e?"용어 해설, 실전 팁, AI 실전 사용법 — 교육과 더불어 공부할 부록 자료":"Glossary, practical tips, and hands-on AI guides — supporting material to study alongside the training",path:"/appendix",dataFiles:n})}export{w as default};
