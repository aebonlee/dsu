import{l as e}from"./index-D-sGx3ne.js";import{G as t}from"./GuidePage-CJi8ES7n.js";/* empty css                 */import"./SEOHead-DVHPklmG.js";import"./CodeBlock-DjF0rxOC.js";import"./index-ClwKp5hb.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Stuck on a term? Ask multi-LLM to "explain this so a new staff member understands."`}]},r={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
...
- Whatever AI you use, minimize sensitive data — never input exam items or student info.`}]},i={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]},n={id:"ai-practice",icon:"fa-comment-dots",title:"AI 실전 사용법",titleEn:"AI Tools in Practice",sections:[{title:"실전 핵심 요약",titleEn:"Practical Essentials",content:`### 1. 기본 원리 — 구체적으로 물을수록 실전 답이 나옵니다
...
> **One-line request**: "Format this to paste straight into Word — **no markdown symbols or checkboxes**, headings as '1. / 1.1' outline numbers only."`}]};function u(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 실전 팁, AI 실전 사용법 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,r,n,i]})}export{u as default};
