import{C as n,l as e,L as i}from"./index-ByG91sz4.js";import{G as a}from"./GuidePage-Cc5vQU7S.js";import{E as o}from"./EnNote-CV0Wnogr.js";import{P as s}from"./PromptEvalNav-BMWY9lb_.js";/* empty css                 */import"./SEOHead-Du3MfgRM.js";import"./CodeBlock-B9Gsypzi.js";import"./index-DxzpPjhK.js";const c={id:"prompt-basics",icon:"fa-lightbulb",title:"프롬프트 기초",titleEn:"Prompt Fundamentals",sections:[{title:"프롬프트란 무엇인가",titleEn:"What is a Prompt",content:`AI 모델에게 원하는 결과를 얻기 위해 전달하는 입력 텍스트를 <strong>프롬프트(Prompt)</strong>라고 합니다.
...
> 좋은 프롬프트의 핵심은 <strong>구체성</strong>, <strong>명확성</strong>, <strong>맥락 제공</strong> 세 가지입니다.`,contentEn:`The input text you provide to an AI model to get desired results is called a **Prompt**.
...
> Prompt writing is not about "getting it perfect the first time" but about "iterative improvement."`}]},l={id:"prompt-evaluation",icon:"fa-clipboard-check",title:"평가 기준 & 루브릭",titleEn:"Evaluation Criteria & Rubrics",sections:[{title:"프롬프트 평가 기준",titleEn:"Prompt Evaluation Criteria",content:`프롬프트의 품질을 객관적으로 평가하기 위한 5대 평가 기준입니다.
...
> Prompt writing skill is not innate — it improves with repeated practice.`}]},p={id:"prompt-techniques",icon:"fa-wand-magic-sparkles",title:"프롬프트 기법",titleEn:"Prompt Techniques",sections:[{title:"핵심 프롬프트 기법",titleEn:"Core Prompt Techniques",content:`AI에서 효과적으로 사용되는 핵심 프롬프트 기법들을 소개합니다.
...
> Advanced strategies are most effective when applied after mastering fundamental techniques.`}]},m={id:"prompt-examples",icon:"fa-flask",title:"실전 예시 & 실습",titleEn:"Examples & Practice",sections:[{title:"GitHub Copilot 프롬프트 예시",titleEn:"GitHub Copilot Prompt Examples",content:`GitHub Copilot에서 실제 사용하는 프롬프트 예시와 평가입니다.
...
> Practice grows faster with colleagues than alone. Actively use team exercises.`}]};function x(){const{language:r}=n(),t=r==="ko";return e.jsx(e.Fragment,{children:e.jsx(a,{seoTitle:"프롬프트 실습",seoTitleEn:"Prompt Lab",seoDescription:t?"프롬프트 작성 기법, 평가 기준, 실전 예시 및 실습 가이드":"Prompt writing techniques, evaluation criteria, worked examples, and a hands-on practice guide",path:"/prompt-eval",dataFiles:[c,l,p,m],sidebarHeader:e.jsx(s,{}),sidebarFooter:e.jsxs(e.Fragment,{children:[e.jsxs(i,{to:"/prompt-eval/workshop",className:"guide-sidebar-cta workshop",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),e.jsxs("div",{children:[e.jsx("strong",{children:t?"프롬프트 작성 평가":"Writing Evaluation"}),e.jsx("span",{children:t?"자동 채점 & 수정 재평가":"Auto-score & re-evaluate"})]})]}),e.jsxs(i,{to:"/prompt-eval/practice",className:"guide-sidebar-cta practice",children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),e.jsxs("div",{children:[e.jsx("strong",{children:t?"종합 실습 테스트":"Full Practice Test"}),e.jsx("span",{children:t?"퀴즈 + 평가 + 작성 (250점)":"Quiz + Eval + Write (250pts)"})]})]})]}),ctaBanner:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"프롬프트 작성 평가":"Prompt Writing Evaluation"}),e.jsxs("p",{children:[t?"프롬프트를 직접 작성하고 SCORE 기준으로 자동 채점! 수정하며 점수 변화를 확인하세요.":"Write your own prompt and have it scored automatically against the SCORE criteria. Revise it and watch your score change.",e.jsx(o,{block:!0,text:"Write your own prompt and have it scored automatically against the SCORE criteria. Revise it and watch your score change."})]})]}),e.jsxs(i,{to:"/prompt-eval/workshop",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),t?"작성 평가 시작":"Start Workshop"]})]}),e.jsxs("div",{className:"prompt-practice-cta",style:{background:"rgba(56,161,105,0.12)",borderColor:"rgba(56,161,105,0.32)"},children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"종합 실습 테스트":"Full Practice Test"}),e.jsxs("p",{children:[t?"선택형 퀴즈 + 프롬프트 평가 + 직접 작성까지, 250점 만점 종합 실습을 진행하세요.":"A full 250-point practice session: multiple-choice quiz, prompt evaluation, and writing your own prompts.",e.jsx(o,{block:!0,text:"A full 250-point practice session: multiple-choice quiz, prompt evaluation, and writing your own prompts."})]})]}),e.jsxs(i,{to:"/prompt-eval/practice",className:"prompt-practice-cta-btn",style:{background:"#2f855a"},children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),t?"종합 실습 시작":"Start Practice"]})]})]})})})}export{x as default};
