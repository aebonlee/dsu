import{l as s}from"./index-DBK-XSXm.js";import{G as i}from"./GuidePage-qTGqrtpm.js";import"./SEOHead-Diecj9i5.js";import"./index-CoV2LDXO.js";import"./index-C6hi0ZM1.js";const a={id:"about",icon:"fa-circle-info",title:"About",titleEn:"About",sections:[{title:"개발 취지",titleEn:"Purpose",content:`**동신대학교 교수자 AI 역량 강화 연수**는 인문사회·예체능 계열 교수자가 생성형 AI(Claude)를 **실제 수업 준비·평가·피드백에 바로 적용**할 수 있도록 돕기 위해 만든 실습 중심 학습 사이트입니다.

AI 도구는 많지만 정작 어려운 것은 *"내 수업에 어떻게 쓰지?"* 입니다. 그래서 **강의는 최소, 실습은 최대**로 두고, 모든 실습을 [역할]·[맥락]·[요청]·[형식]·[예시]·[조건] 라벨이 붙은 **정석 프롬프트**로 제공해 구조 자체가 몸에 익도록 설계했습니다.
...
| **바로 실습** | 모든 교시에 Claude에 그대로 입력하는 **복사용 정석 프롬프트** 101개 제공 |
