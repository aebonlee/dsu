...
> 실습은 유사한 연습 문항으로, 실전 문항은 AI가 만든 초안을 <strong>변형</strong>해서 사용하세요.`,
...
> 완벽한 도구보다 <strong>수업에 실제로 쓰는 도구</strong>가 이깁니다.`,
...
> 오늘 만든 산출물 중 하나를 골라, 다음 수업에서 바로 써 보세요.`,
  ...
  },
  {
    id: 'day1-leveled',
    categoryId: 'day1',
    nameKo: '수준별·문체별 변환 템플릿집 (시연용)',
    nameEn: 'Leveled Text & Style Conversion Templates',
    type: 'template',
    contentKo: `## 수준별·문체별 변환 템플릿집
...
> "수준"과 "문체"가 서로 다른 축이라는 것이 한눈에 전달됩니다.`,
    contentEn: `## Leveled & Style Conversion Templates\n\nCopy-paste templates for three-level conversion, international-student-friendly rewriting, difficulty ladders, and style shifts (conversational, academic, journalistic, storytelling) — two independent axes: reader level and classroom situation.`,
  },
  {
    id: 'day2-itembank',
    categoryId: 'day2',
    nameKo: '평가 유형별 문항 예시 은행 (인문사회·예체능)',
    nameEn: 'Assessment Item Bank by Type (H&A)',
    type: 'reference',
    contentKo: `## 평가 유형별 문항 예시 은행
...
> ⚠️ 다시 한번: 이 은행의 문항을 실전에 쓸 때는 **변형해서** 쓰고, 확정된 실전 문항은 AI에 입력하지 마세요.`,
    contentEn: `## Assessment Item Bank\n\nReady-to-adapt item skeletons for all five types — essay, critical, performance, portfolio, presentation — plus semester-level combination recipes and the security rule: adapt before use, never input finalized exam items.`,
  },
  {
    id: 'day3-toolideas',
    categoryId: 'day3',
    nameKo: '바이브코딩 수업 도구 아이디어 20선',
    nameEn: '20 Vibe-Coding Class Tool Ideas',
    type: 'reference',
    contentKo: `## 바이브코딩 수업 도구 아이디어 20선
...
> — 셋 중 둘 이상이면 만들 가치가 있습니다.`,
    contentEn: `## 20 Vibe-Coding Tool Ideas\n\nClass-tool ideas by field — debate trainers, role-play interviewers, writing workbooks, performance journals, plus classroom-ops utilities — with a request formula and a three-question test for which tools are worth building.`,
  },
  {
    id: 'day3-pbl',
    categoryId: 'day3',
    nameKo: 'PBL·프로젝트 수업 시나리오 예시집',
    nameEn: 'PBL & Project Scenario Collection',
    type: 'guide',
    contentKo: `## PBL·프로젝트 수업 시나리오 예시집
...
> AI가 준비 부담을 덜어주는 만큼, 팀 면담과 피드백에 시간을 쓰는 것이 PBL 성공의 핵심입니다.`,
    contentEn: `## PBL Scenario Collection\n\nA 30-second PBL refresher, four conditions of a good problem, field-specific scenario examples (regional culture, controversy archive, department showcase), a stage-by-stage AI-use table for instructor vs. students, and a team check-in question prompt.`,
  },
];
