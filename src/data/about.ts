/** About — 개발 취지 + 강사 소개(정동엽) · jnu(cnu) About 포맷 이식 */
export default {
  id: 'about',
  icon: 'fa-circle-info',
  title: 'About',
  ...
  sections: [
    {
      title: '개발 취지',
      titleEn: 'Purpose',
      content: `<strong>동신대학교 교수자 AI 역량 강화 연수</strong>는 인문사회·예체능 계열 교수자가 생성형 AI(Claude)를 <strong>실제 수업 준비·평가·피드백에 바로 적용</strong>할 수 있도록 돕기 위해 만든 실습 중심 학습 사이트입니다.
...
> 컴퓨터가 서툴러도 괜찮습니다. 각 실습의 회색 상자(프롬프트)를 **복사 → Claude에 붙여넣기 → [대괄호]만 내 과목으로 바꾸기**, 이 3가지면 충분합니다.`,
      contentEn: `**Dongshin University Faculty AI Competency Training** is a practice-oriented site helping humanities & arts faculty apply generative AI (Claude) directly to lesson preparation, assessment, and feedback.
...
- **Padlet** — share your outputs via the button on each Day page`,
    },
    {
      title: '정동엽 강사',
