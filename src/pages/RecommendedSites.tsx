...
const SITES: SiteItem[] = [
  ...
  {
    name: 'ChatGPT 학습 가이드',
    nameEn: 'ChatGPT Learning Guide',
    url: 'https://chatgpt.dreamitbiz.com',
    icon: 'fa-robot',
    descKo: 'ChatGPT 활용법을 기초부터 익히는 학습 사이트입니다.',
    descEn: 'A learning site for mastering ChatGPT from the basics.',
    category: 'company',
  },
  {
    name: 'Claude 학습 가이드',
    nameEn: 'Claude Learning Guide',
    url: 'https://claude.dreamitbiz.com',
    icon: 'fa-brain',
    descKo: 'Claude 활용법을 기초부터 익히는 학습 사이트입니다. 본 연수의 중심 도구입니다.',
    descEn: 'A learning site for mastering Claude — the primary tool of this program.',
    category: 'company',
  },
  {
    name: 'Gemini 학습 가이드',
    nameEn: 'Gemini Learning Guide',
    url: 'https://gemini.dreamitbiz.com',
    icon: 'fa-gem',
    descKo: 'Google Gemini 활용법을 기초부터 익히는 학습 사이트입니다.',
    descEn: 'A learning site for mastering Google Gemini from the basics.',
    category: 'company',
  },
  {
    name: 'Genspark 학습 가이드',
    nameEn: 'Genspark Learning Guide',
    url: 'https://genspark.dreamitbiz.com',
    icon: 'fa-bolt',
    descKo: 'AI 에이전트 Genspark 활용법을 익히는 학습 사이트입니다.',
    descEn: 'A learning site for mastering the Genspark AI agent.',
    category: 'company',
  },
];
